<div class="row" id="box-search" style="margin-top:-30px;">
   ...
   <img src="statics/layananbanner.jpg" class="imgs" style="width:100%;height:400px;z-index:-2">
         ...
         <div class="text-white"><h2><u>Galeri Desa Bidang <?php echo $_GET['kategori'];?></u></h2></div>
          <div style="height:20px"></div>
            <div class="fonts">
               <p>Temukan berbagai informasi Galeri desa bidang <?php echo $_GET['kategori'];?> di laman ini.</p>
            </div>
         </div>
...
<div class=" row  "  >
    <div class="col" >
        <div class="row justify-content-center  mx-2" id="box-search">
            <?php
                $query = mysqli_query($con, "SELECT * FROM galeri where kategori ='$_GET[kategori]' ");
                while($data = mysqli_fetch_array($query)){
            ?>
            
                <div class="gallery" style="margin-right:1%;background:#E6E6E6;margin-top:1%;">
                    <a target="_blank" src="images/<?= $data['foto'];?>">
                        <img src="images/<?= $data['foto'];?>" alt="Cinque Terre" width="600" height="400">
                    </a>
